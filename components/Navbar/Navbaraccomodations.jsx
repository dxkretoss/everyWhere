    ...
    return (
        <nav className="w-full h-[80px] border border-[#EBEBEB] flex items-center justify-between bg-white">
            ...
            <div className="flex items-center gap-4 mr-2">
                <button className="w-[160px] h-[45px] hidden md:block bg-white border border-[#EBEBEB]  text-[#FFAB24] font-poppins font-semibold text-sm leading-none tracking-normal px-4 py-2 rounded-lg hover:bg-blue-50 transition">
                    PUBLISH AN OFFER
                </button>
                <div className="flex items-center gap-3">
                    ...
                    <div class="w-[45px] h-[45px] opacity-100 rounded-[10px] border gap-[10px] border-[#EBEBEB] s px-[12px] py-[10px] flex items-center justify-center">
