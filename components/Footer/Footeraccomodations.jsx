...
export default function Footeraccomodations() {
    return (
        <footer className="w-full flex flex-col text-white">
            {/* Top Links Section */}
            <div className="w-full h-[49px] bg-[#FFAB24] px-4 py-3">
            ...
            {/* Bottom Section */}
            <div className="w-full  h-[50px] bg-[#FFC973] flex flex-col sm:flex-row items-center sm:items-center justify-between px-4 sm:px-8 md:px-12 py-3 gap-3">
                {/* Left Section */}
