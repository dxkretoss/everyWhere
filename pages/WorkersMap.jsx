                ...
                >
                    {filterButtons.map((btn, idx) => (
                        <HomePgaebutton
                            ...
                            rightImg={idx < 2 ? "/dropdown.png" : "/arrow.svg"}
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 py-3">
                        ...
                        <div className="flex items-center gap-4">
                            <div className="flex rounded-md bg-[#f9f9f9] p-1 overflow-hidden">
                                {/* Jobs button */}
                                <button
                                    onClick={() => router.push("/WorkersMap")}
                        ...
                        {/* Right section */}
                        <div className="h-[21px] w-[187px] flex items-center gap-1 text-sm text-gray-600 cursor-pointer">
