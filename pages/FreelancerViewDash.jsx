    ...
    return (
        <Layout>
            <div className='h-[57px] flex items-center justify-center'>
                <h1 className='text-[24px] font-semibold text-[#000000]'>My Gigs</h1>
            </div>
                        ...
                        <div className='w-[385px] h-[107px] border border-[#757575] content-center rounded-[20px] bg-white p-3'>
                            <div className='flex justify-between items-center'>
                                ...
                                <div className='flex flex-col items-end gap-2'>
                                    ...
                                    <span className='text-[#000000] text-[16px] font-semibold'>Gigs on your profile</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='w-[385px] h-[107px] border border-[#757575] content-center rounded-[20px] bg-white p-3'>
                            <div className='flex justify-between items-center'>
                                ...
                                <div className='flex flex-col items-end gap-2'>
                                    ...
                                    <span className='text-[#000000] text-[16px] font-semibold'>Missions</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="w-[1227px] h-[1018px] mx-auto justify-center mb-[20px]">
                        ...
                        <div key={cardId}>
                            <div className={` ${selectedCard === cardId ? "bg-[#F4F4F4] rounded-t-[20px]" : "bg-white"} p-[25px] transition-colors`}>
                                <div
                                    ...
                                    className={`cursor-pointer relative w-[359px] h-[460px] 
                ...
                {selectedCard === 1 ? (
                    <div className='h-[500px] w-[1227px] flex flex-col rounded-bl-[20px] rounded-tr-[20px] rounded-br-[20px] bg-[#F4F4F4] relative'>
                            ...
                            <div className='flex flex-col gap-[50px]'>
                                <div className='flex flex-col gap-[50px]'>
                                    <div className='flex gap-[50px]'>
                                        <div className="relative w-[356px] h-[360px] border-[1px] border-[#CECECE] rounded-[20px] shadow-[4px_4px_11px_0px_#75757578] bg-white flex flex-col overflow-hidden">
                ...
                {selectedCard === 2 ? (
                    <div className='h-[500px] w-[1227px] flex flex-col rounded-[20px] bg-[#F4F4F4] relative'>
                        <div className="flex justify-center items-center py-[25px]">
                            <div className="w-[381px] h-[52px] bg-white flex justify-center items-center shadow-[0px_4px_11px_0px_#CECECEC7] rounded-[10px]">
                                {buttons.map((btn) => (
                                    <button
                ...
                {selectedCard === 3 ? (
                    <div className='h-[500px] w-[1227px] flex flex-col rounded-bl-[20px] rounded-tl-[20px] rounded-br-[20px] bg-[#F4F4F4] relative'>
                        <div className="flex justify-center items-center py-[25px]">
                            <div className="w-[381px] h-[52px] bg-white flex justify-center items-center shadow-[0px_4px_11px_0px_#CECECEC7] rounded-[10px]">
                                {buttons.map((btn) => (
                                    <button
