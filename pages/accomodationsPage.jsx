...
export default function accomodationsPage() {
    ...
    const filterButtons = [
        ...
        { leftImg: "/accomodationsPage/Others.svg", text: "Others", minWidth: "129px" },
    ]
        ...
        <div className="flex flex-col h-screen">
            ...
            <div className="shadow-[0px_4px_6px_0px_rgba(0,0,0,0.11)] sticky top-[64px] z-40 bg-white px-5 py-2 flex items-center gap-6 justify-between">
                ...
                <div className="flex sm:hidden gap-2 w-full">
                    ...
                    <button className="font-semibold w-1/2 flex items-center justify-center gap-2 bg-[#FFAB24] text-white px-4 py-2 rounded-[10px] shadow hover:bg-[#1e90c2] transition">
                ...
                >
                    {filterButtons.map((btn, idx) => (
                        <HomePgaebutton
                            ...
                            className={`h-[38px] font-medium whitespace-nowrap border ${idx < 2
                ...
                <div className="hidden sm:flex flex-shrink-0">
                    <button className="flex items-center gap-2 bg-[#FFAB24] text-white px-4 py-2 rounded-[10px] shadow hover:bg-[#FFAB24] transition whitespace-nowrap">
                        <img src="/accomodationsPage/bell.svg" alt="save" className="w-4 h-4" />
                        <span className="text-sm font-medium">SAVE SEARCH</span>
                    </button>
                </div>
            ...
            <div className="flex flex-1 overflow-hidden bg-white">
                ...
                <div className="relative hidden lg:block w-2/5">
                    ...
                    <div
                        ...
                        class="absolute bottom-4 left-1/2 -translate-x-1/2 bg-white px-[15px] py-[10px] rounded-[10px] shadow-[0_3px_12px_rgba(0,0,0,0.15)] text-[#29ABE2] text-[12px] flex items-center gap-[10px] z-[999]"
                    >
                        <input
                            type="checkbox"
           ...
           checked:after:flex checked:after:items-center checked:after:justify-center"
                        />
                        <label for="accommodation-toggle" class="cursor-pointer select-none text-[12px] font-medium text-[#29ABE2]">
