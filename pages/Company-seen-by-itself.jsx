...
export default function Profileseenbyvisitors() {
    ...
    return (
        <Mainlayout>
            <div className="flex justify-end items-center gap-3 pr-[40px]">

                <div className="flex items-center gap-3">
                    <button
                        className="w-[157px] h-[46px] flex items-center justify-center 
                    gap-[6px] rounded-[10px] px-[12px] py-[10px] 
                    border border-[#000000]/60 text-[#000000] text-[14px] font-medium"
                    >
                        <img src="/eyes.png" alt="View icon" className="w-[19px] h-[13px]" />
                        View as Visitor
                    </button>
                    <button
                        className="w-[156px] h-[46px] flex items-center justify-center gap-[8.4px] rounded-[10px] 
             px-[15.11px] py-[10.08px] border border-[#000000]/60 text-[#FFFFFF] bg-[#000000]  text-[14px]  font-medium"
                    >
                        Post a Job Offer !
                    </button>
                ...
                <div className="flex flex-col lg:flex-row gap-10 px-4 pt-10 justify-center">
                    ...
                    <div className="lg:col-span-2 space-y-5 w-full lg:w-[70%]">
                        ...
                        <div className="bg-white h-[202px] w-[982px] rounded-[25px] shadow-md p-6 flex flex-col relative">
                            ...
                            <div className="absolute -top-[60px] left-1/2 transform -translate-x-1/2">
                                <div className="relative w-[136px] h-[136px]">
                                    ...
                                    />
                                    <span className="absolute top-20 right-5 w-[38px] h-[39px]">
                        ...
                        <div className="bg-white h-[129px] w-[982px] rounded-[25px] shadow-md mx-auto">
                            <div className="grid grid-cols-[30%_45%_25%] divide-x divide-gray-200 text-center">
                                {/* Contract */}
                        ...
                        {/* Our Opportunities */}
                        <div className="bg-white h-[396px] w-[982px] rounded-[25px] shadow-md p-6 flex flex-col relative">
                            <div className="relative flex items-center mb-2">
                                <h1 className="absolute left-1/2 transform -translate-x-1/2 font-semibold text-[#000000] text-[16px]">Our Opportunities</h1>
                                            ...
                                            .map((_, i) => (
                                                ...
                                                >
                                                    <div className="relative">
                                                        ...
                                                        {/* Overlay for the 3rd image only */}
                                                        {i === 2 && (
                                                            <div className="h-[20px] w-[195px] absolute top-3 left-1/2 -translate-x-1/2 flex items-center gap-2 rounded-lg  py-1 text-[#FFFFFF] text-sm font-medium">
                                                                <span>Upload from Instagram</span>
                                                                <img
