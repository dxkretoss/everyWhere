...
export default function FrelancerProfilebyhimself() {
    useEffect(() => {
        document.title = 'Freelancer profile (seen by freelancer himself)'
    }, [])
            ...
            <div className="min-h-screen">
                ...
                <div className="flex gap-10 px-4 pt-8 justify-center">
                    <div className="lg:col-span-2 space-y-5 w-full lg:w-[70%]">
                        ...
                        <div className="bg-[#EAF7FC] border border-[#29ABE2] h-[102px] w-[982px] rounded-[10px] shadow-[0px_4px_6px_0px_#7575751A] mx-auto">
                                    ...
                                    >
                                        ...
                                        <div className="absolute top-[34px]">
                                            <div className="relative">
                                                <img
                                                    src={profile.img}
                                                    className="rounded-full w-[65px] h-[65px] object-cover border-2 border-white shadow-[0px_4px_6px_0px_#7575751A]"
                                                    alt={profile.name}
                                                />
                                                {/* Badge */}
