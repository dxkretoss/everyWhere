...
export default function received_applications() {
    useEffect(() => {
        document.title = 'Received Applications Dashboard (premium account)'
    }, [])
    ...
    return (
        <Layout>
            ...
            <div className="w-[1227px] h-[1460px] mx-auto justify-center mb-[20px]">
                ...
                {selectedCard === 2 ? (
                    <div className='h-[942px] w-[1227px] flex flex-col rounded-[20px] bg-[#F4F4F4]'>
                        <div className="flex justify-center items-center py-[25px]">
                            <div className="w-[381px] h-[52px] bg-white flex justify-center items-center shadow-[0px_4px_11px_0px_#CECECEC7] rounded-[10px]">
                                {buttons.map((btn) => (
                                    <button
                ...
                {selectedCard === 3 ? (
                    <div className='h-[942px] w-[1227px] flex flex-col rounded-bl-[20px] rounded-tl-[20px] rounded-br-[20px] bg-[#F4F4F4]'>
                        <div className="flex justify-center items-center py-[25px]">
                            <div className="w-[381px] h-[52px] bg-white flex justify-center items-center shadow-[0px_4px_11px_0px_#CECECEC7] rounded-[10px]">
                                {buttons.map((btn) => (
                                    <button
