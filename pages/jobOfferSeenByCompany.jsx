                ...
                <div className="h-[27px] flex flex-col sm:flex-row justify-between items-center mb-4 sm:mb-0">
                    ...
                    <div className="flex items-center mb-2 sm:mb-0">
                        <p className="flex items-center gap-1 sm:gap-2">
                            <img
                                src="/basil_user-plus-outline.png"
                                ...
                                <div className="flex flex-col items-end">
                                    ...
                                    <div className="relative flex items-center gap-2 mb-3">
                                        ...
                                        <div className="ml-auto">
                                            <img src="/Editblue.png" alt="edit" className="cursor-pointer" />
                                        </div>
                                    </div>
    ...
    checked:after:flex checked:after:items-center checked:after:justify-center"
                        ...
                        <div className="bg-white mx-auto w-[982px] h-[199px] shadow-[0_4px_6px_rgba(117,117,117,0.1)] rounded-[25px] p-[32px_24px]">
                            <div className="grid grid-cols-3 h-full">
                                ...
                                {/* Languages */}
                                <div className="w-full flex flex-col items-center text-center justify-center border-x border-[#F5F5F5]">
                                    {/* <div className="flex items-center justify-center mb-2">
                                        <h3 className="font-semibold text-[16px] leading-[19.78px] text-[#333333] mb-6">
                                            Languages
                                        </h3>
                                        <img
                                            src="/Editblue.png"
                                            alt="edit"
                                            className="cursor-pointer ml-2 w-[16px] h-[16px]"
                                        />
                                    </div> */}
                                ...
                                <div className="flex flex-col items-center text-center justify-center w-full">
                                    {/* <div className="flex items-center justify-center mb-2">
                                        <h3 className="font-semibold text-[16px] leading-[20px] text-[#333333]">
                                            Skills
                                        </h3>
                                        <img
                                            src="/Editgrey.png"
                                            alt="edit"
                                            className="cursor-pointer ml-2 w-[18px] h-[18px]"
                                        />
                                    </div> */}
                                    ...
                                    <div className="text-center p-4">
                                        <div className="relative flex items-center mb-2">
                                            {/* Centered Title */}
                                            <h3 className="absolute left-1/2 transform -translate-x-1/2 font-semibold text-[16px] leading-[20px] text-[#333333]">
                                                Skills
                                            </h3>
                        ...
                        <div className="p-6 bg-white mx-auto w-[982px] flex flex-col justify-start items-center bg-global-12 rounded-[24px] shadow-[0px_4px_6px_#75757519] px-[20px] py-[20px]">
                            <div className="relative w-full flex items-center">
                                {/* Centered Text */}
                                <h1 className="absolute left-1/2 transform -translate-x-1/2 text-[16px] text-[#000000] font-semibold">
                                    Description
                                </h1>
                            ...
                            <div className="flex flex-col justify-start items-center w-full mt-[24px] mb-[10px]">
                                ...
                                <div className="flex flex-col gap-[8px] justify-start items-start w-full mt-[20px] mx-[142px]">
                                    ...
                                    <div className="relative w-full flex items-center">
                                        {/* Centered Text */}
                                        <h1 className="w-full text-center text-[16px] font-poppins font-semibold leading-[24px] text-global-1">
                                            Responsibilities
                                        </h1>
                                ...
                                <div className="relative w-full flex items-center">
                                    {/* Centered Text */}
                                    <h1 className="w-full text-center text-[16px] font-poppins font-semibold leading-[24px] text-global-1 mt-[18px]">
                                        Qualifications
                                    </h1>
                                ...
                                {/* Notice */}
                                <div
                                    className="w-[918px] h-[114px] flex items-center border border-gray-500 rounded-lg px-4 mt-3 relative"
                                ...
                                >
                                    ...
                                    <div className="w-full flex justify-center">
                                        <div className="w-[638px] h-[48px] flex items-center justify-center">
                                            <p className="font-poppins font-normal text-sm leading-6 tracking-normal text-center text-[#757575]">
                                                ...
                                                <span>
                                                    , consider the job offer closed at the moment. We look forward to
                                                    hearing from you!
                                                </span>
                                            </p>
                                        </div>
                        ...
                        {/* Workplace Overview */}
                        <div className="bg-white w-[982px] h-[503px] rounded-[25px] shadow-md p-6 flex flex-col">
                            <div className="relative flex items-center mb-4">
                                <h3 className="absolute left-1/2 transform -translate-x-1/2 font-semibold text-[#000000] text-[16px]">
                                    Workplace Overview
                                </h3>
                            ...
                            <div className="mb-2 flex justify-center">
                                <div className="w-[918px] h-[314px] flex flex-col items-center justify-center bg-[#E6E6E6] border-2 border-dashed border-gray-400 rounded-[20px] ">
                                    {selectedImage ? (
                                        <img
                                            src={selectedImage}
                                        ...
                                        <>
                                            ...
                                            <label
                                                htmlFor="file-upload"
                                                className="flex items-center justify-center w-[220px] h-[53px] bg-[#29ABE2] text-[#FFFFFF] rounded-[10px] cursor-pointer transition"
                                            >
                                                Upload Workplace Picture
                                            </label>
                            ...
                            <div className="bg-[#EAF7FC] h-[66px] w-[918px] rounded-[999px] mt-5 pt-[10px] pb-[10px] pl-[80px] pr-[80px] flex justify-center items-center">
