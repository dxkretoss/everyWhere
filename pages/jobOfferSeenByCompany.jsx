            ...
            <div className="min-h-screen">
                ...
                <div className="flex gap-3 px-4 pt-10 justify-center">
                    ...
                    <div className="lg:col-span-2 space-y-5">
                            ...
                            <div className="grid grid-cols-3 h-full  divide-x divide-[#E5E5E5]">
                                ...
                                <div className="flex flex-col items-center text-center justify-center relative p-[32px_24px]">
                                    ...
                                    <div className="z-1 h-[24px] flex items-center mb-6">
                                        <h3 className="font-semibold text-[16px] leading-[19.78px] text-[#000000]">
                                            Contract & Experience
                                        </h3>
                                        ...
                                        <div className='flex flex-col gap-6 items-center'>
                                            <div className='flex gap-4 items-center '>
                                                <img
                                                    src="/other2.svg"
                                                    alt="UK flag"
                                                    className="w-[44px] h-[44px] rounded-sm object-cover"
                                                />
                                                <img
                                                    src="/other1.svg"
                                                    alt="Italian flag"
                        ...
                        <div className="bg-white mx-auto w-[982px] flex flex-col justify-start items-center bg-global-12 rounded-[24px] shadow-[0px_4px_6px_#7575751A] px-[20px] py-[20px] relative">
                            ...
                            <div className="flex flex-col justify-start items-center w-full mt-[24px] mb-[10px]">
                                ...
                                <div className="flex flex-col gap-[8px] justify-start items-start w-full mt-[20px] mx-[142px]">
                                    ...
                                    <div className="ml-auto">
                                        <img src="/Editgrey.svg" alt="edit" className='absolute top-35 right-5 w-[18px] h-[18px] cursor-pointer' />
                                    </div>
                                ...
                                <div className="flex flex-col gap-[8px] justify-start items-center w-full mt-[18px] mx-[190px]">
                                    ...
                                    <div className="ml-auto">
                                        <img src="/Editgrey.svg" alt="edit" className='absolute top-80 right-5 w-[18px] h-[18px] cursor-pointer' />
                                    </div>
                                ...
                                <div className="ml-auto">
                                    <img src="/Editgrey.svg" alt="edit" className='absolute top-125 right-5 w-[18px] h-[18px] cursor-pointer' />
                                </div>
                                ...
                                {/* Notice */}
                                <div className="w-[918px] h-[114px] flex justify-start items-center border border-[#757575] rounded-[10px] px-4 mt-3 relative" style={{ backgroundColor: '#f7f7f7f7' }}>
                                    <div className="ml-auto">
                                        <img src="/Editgrey.svg" alt="edit" className='absolute top-5 right-5 w-[18px] h-[18px] cursor-pointer' />
                                    </div>
                                    <img
                                    ...
                                    <span className="font-poppins font-normal text-[14px] leading-6 tracking-normal text-center w-full ml-11 text-[#757575]">
                                        ...
                                        <span className="text-[#757575] font-semibold border border-[#757575] rounded-md bg-white px-2 py-1">
                                            2 weeks
                                        </span>
                                        {" "}
                                        <span>
                        ...
                        {/* Workplace Overview */}
                        <div className="bg-white mx-auto w-[982px] h-[421px] flex flex-col justify-start items-center bg-global-12 rounded-[24px] shadow-[0px_4px_6px_#7575751A] px-[20px] py-[20px] relative">
                                ...
                                {selectedImage ? (
                                    ...
                                    <>
                                        ...
                                        <div className="flex items-center mt-4">
                                            ...
                                            >
                                                Make my content eligible to be reposted on Everywhere Jobs’ Socials & Communications
                                            </label>
                                        </div>
                                    </>
                                )}
